...
export default function AppointmentsPage() {
  ...
  const handleAssignDoctor = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({
        type: "error",
        text: err.message || "Failed to assign doctor",
      });
    }
  };
  ...
  const handleCompleteAppointment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({
        type: "error",
        text: err.message || "Failed to complete appointment",
      });
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleBookAppointment} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setBookForm({ ...bookForm, apptdate: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setBookForm({ ...bookForm, appttime: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setBookForm({ ...bookForm, apptcost: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md"
                />
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <form onSubmit={handleAssignDoctor} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Appointment Time (24HR format with seconds)
                </label>
                <input
                  type="time"
                  step="1"
